! function (a) {
    ...
    return b.defaults = {
        ...
        nextBtnCaption: "ileri",
        prevBtnCaption: "Geri",
        loadingCaption: "Yukleniyor...",
        bindToItems: !0,
        ...
        normalizePosition: function (a) {
            return a >= this.items.length ? a = 0 : 0 > a && (a = this.items.length - 1), a
        },
        ...
        setupLightboxHtml: function () {
            var b = this.options;
            var sosyal = "<ul id='paylasimlightbox' class='tb-social-list'><li>Şimdi Paylaş !</li> <li class='fb'> <i class='fa fa-facebook'></i> </li> <li class='tw'> <i class='fa fa-twitter'></i> </li> <li class='gp'> <i class='fa fa-google-plus'></i> </li> </ul>";
            return this.$el || (this.$el = a('<div class="slbElement ' + b.elementClass + '"><div class="slbOverlay"></div><div class="slbWrapOuter"><div class="slbWrap"><div class="slbContentOuter">'+sosyal+'<div class="slbContent"></div><button type="button" title="' + b.closeBtnCaption + '" class="slbCloseBtn ' + b.closeBtnClass + '">×</button></div></div></div></div>'), this.items.length > 1 && a('<div class="slbArrows"><button type="button" title="' + b.prevBtnCaption + '" class="prev slbArrow' + b.prevBtnClass + '">' + b.prevBtnCaption + '</button><button type="button" title="' + b.nextBtnCaption + '" class="next slbArrow' + b.nextBtnClass + '">' + b.nextBtnCaption + "</button></div>").appendTo(this.$el.find(".slbContentOuter")), this.$content = this.$el.find(".slbContent")), this.$content.empty(), this
        },
        show: function () {
