<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="YazarEkle.aspx.cs" Inherits="Quality_Dergisi.Admin.WebForm15 " %>
                ...
                <div class="widget-content nopadding">
                    <div class="form-horizontal">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="file" runat="server" id="resim" class="span11" />
                        ...
                        <div style="text-align: right;" class="form-actions">
                            <div style="display:none;" id="YazarEkle" class="btn btn-success">Kaydet</div>
