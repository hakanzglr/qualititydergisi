<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="YazarlarYazilar.aspx.cs" Inherits="Quality_Dergisi.Admin.WebForm16" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <div class="container-fluid"> 
    ...
    <HeaderTemplate>
        <div style="font-size:14px!important;font-weight:600;margin-left:10px !important;text-align:left !important" class="row text-center">
         <div class="col-md-5">
        ...
        <ItemTemplate>
            ...
            <div  data-url="YaziDetay.aspx?Hid=<%# DataBinder.Eval(Container.DataItem, "yaziid") %>" style="margin-left:10px !important;" class="detaycss row altcizgi">
            ...
            <div class="col-md-5">
                ...
                <div style="font-size:20px;" class="col-md-1">
                    ...
                    <div class="col-md-1">
                        ...
                        <div class="duzenlelink">
                            <a class="Sil" name="<%# DataBinder.Eval(Container.DataItem, "yaziid") %>"><i class="icon-trash"></i></a>
                        </div>
...
<script src="js/jquery.flot.resize.min.js"></script> --%>
        ...
        <script type="text/javascript">
            ...
            if (confirm("Yazarı silmek istediğinizden emin misiniz?")) {
                ...
                $.ajax({
                    url: "YazarlarYazilarSil.ashx/yaziid=" + ID,//Ajax ile tetiklenecek ilgili adresi belirliyoruz.
                    type: "POST",
                      data: { "veri": ID },
                    success: function (result) {

                        window.location = "YazarlarYazilar.aspx";
                ...
                $("#yazilistele").addClass("active");
                $("#yazaryazilari").addClass("open");
