<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Kategori.aspx.cs" Inherits="Quality_Dergisi.WebForm8" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="icerikplc" runat="Server">
            ...
            <div class="page-head-tile">
                <div class="container">
                    ...
                    <div class="page-title">
                        <h1 class="title-16"><strong><span runat="server" id="BuyukKategoriadi"></span></strong></h1>
    ...
    <div style="opacity: 0; width: 0px !important; display: none">
        ...
        <div id="sayfayukle" runat="server"><%= ResolveUrl("~/SayfaYukle.ashx?tur_id=") %></div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function lastPostFunc() {
                ...
                $.post($("#icerikplc_sayfayukle").html() + katid + "&sonid=" + $("div.col-half:last-child").attr("data-id"),
