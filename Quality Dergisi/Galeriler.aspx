<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="galeriler.aspx.cs" Inherits="Quality_Dergisi.WebForm5" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <title>Foto Galeri - Quality Dergisi - Sosyete ve Magazinin Kalbi </title>
            ...
            <div class="page-head-tile">
                <div class="container">
                    ...
                    <div class="page-title">
                        <h1 class="title-16"><strong>Foto Galeri</strong></h1>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function lastPostFunc() {
                ...
                $.post("../../GaleriYukle.ashx?sonid=" + $("div.col-half:last-child").attr("data-id"),
